...
#####Plot#################################################################
prop_620_FD1=read.csv("E:/GEB data/American_FDis_620_Age1_NaturalForests.csv"  )
prop_620_FD2=read.csv("E:/GEB data/American_FDis_620_Age2_NaturalForests.csv"  )
prop_620_FD3=read.csv("E:/GEB data/American_FDis_620_Age3_NaturalForests.csv"  )
prop_620_FD4=read.csv("E:/GEB data/American_FDis_620_Age4_NaturalForests.csv"  )
prop_620_FD5=read.csv("E:/GEB data/American_FDis_620_Age5_NaturalForests.csv"  )
prop_620_Leaf1=read.csv("E:/GEB data/American_Leaf.FDis_620_Age1_NaturalForests.csv"  )
prop_620_Leaf2=read.csv("E:/GEB data/American_Leaf.FDis_620_Age2_NaturalForests.csv"  )
prop_620_Leaf3=read.csv("E:/GEB data/American_Leaf.FDis_620_Age3_NaturalForests.csv"  )
prop_620_Leaf4=read.csv("E:/GEB data/American_Leaf.FDis_620_Age4_NaturalForests.csv"  )
prop_620_Leaf5=read.csv("E:/GEB data/American_Leaf.FDis_620_Age5_NaturalForests.csv"  )
prop_620_LMA1=read.csv("E:/GEB data/American_LMA.FDis_620_Age1_NaturalForests.csv"  )
prop_620_LMA2=read.csv("E:/GEB data/American_LMA.FDis_620_Age2_NaturalForests.csv"  )
prop_620_LMA3=read.csv("E:/GEB data/American_LMA.FDis_620_Age3_NaturalForests.csv"  )
prop_620_LMA4=read.csv("E:/GEB data/American_LMA.FDis_620_Age4_NaturalForests.csv"  )
prop_620_LMA5=read.csv("E:/GEB data/American_LMA.FDis_620_Age5_NaturalForests.csv"  )

prop_620_WD1=read.csv("E:/GEB data/American_WD_mean_add.FDis_620_Age1_NaturalForests.csv"  )
prop_620_WD2=read.csv("E:/GEB data/American_WD_mean_add.FDis_620_Age2_NaturalForests.csv"  )
prop_620_WD3=read.csv("E:/GEB data/American_WD_mean_add.FDis_620_Age3_NaturalForests.csv"  )
prop_620_WD4=read.csv("E:/GEB data/American_WD_mean_add.FDis_620_Age4_NaturalForests.csv"  )
prop_620_WD5=read.csv("E:/GEB data/American_WD_mean_add.FDis_620_Age5_NaturalForests.csv"  )

prop_620_Nmass1=read.csv("E:/GEB data/American_Nmass.FDis_620_Age1_NaturalForests.csv"  )
prop_620_Nmass2=read.csv("E:/GEB data/American_Nmass.FDis_620_Age2_NaturalForests.csv"  )
prop_620_Nmass3=read.csv("E:/GEB data/American_Nmass.FDis_620_Age3_NaturalForests.csv"  )
prop_620_Nmass4=read.csv("E:/GEB data/American_Nmass.FDis_620_Age4_NaturalForests.csv"  )
prop_620_Nmass5=read.csv("E:/GEB data/American_Nmass.FDis_620_Age5_NaturalForests.csv"  )

prop_620_Pmass1=read.csv("E:/GEB data/American_Pmass.FDis_620_Age1_NaturalForests.csv"  )
prop_620_Pmass2=read.csv("E:/GEB data/American_Pmass.FDis_620_Age2_NaturalForests.csv"  )
prop_620_Pmass3=read.csv("E:/GEB data/American_Pmass.FDis_620_Age3_NaturalForests.csv"  )
prop_620_Pmass4=read.csv("E:/GEB data/American_Pmass.FDis_620_Age4_NaturalForests.csv"  )
prop_620_Pmass5=read.csv("E:/GEB data/American_Pmass.FDis_620_Age5_NaturalForests.csv"  )

prop_620_ST1=read.csv("E:/GEB data/American_Shade.tolerance.FDis_620_Age1_NaturalForests.csv"  )
prop_620_ST2=read.csv("E:/GEB data/American_Shade.tolerance.FDis_620_Age2_NaturalForests.csv"  )
prop_620_ST3=read.csv("E:/GEB data/American_Shade.tolerance.FDis_620_Age3_NaturalForests.csv"  )
prop_620_ST4=read.csv("E:/GEB data/American_Shade.tolerance.FDis_620_Age4_NaturalForests.csv"  )
prop_620_ST5=read.csv("E:/GEB data/American_Shade.tolerance.FDis_620_Age5_NaturalForests.csv"  )

prop_620_DT1=read.csv("E:/GEB data/American_Drought.tolerance.FDis_620_Age1_NaturalForests.csv"  )
prop_620_DT2=read.csv("E:/GEB data/American_Drought.tolerance.FDis_620_Age2_NaturalForests.csv"  )
prop_620_DT3=read.csv("E:/GEB data/American_Drought.tolerance.FDis_620_Age3_NaturalForests.csv"  )
prop_620_DT4=read.csv("E:/GEB data/American_Drought.tolerance.FDis_620_Age4_NaturalForests.csv"  )
prop_620_DT5=read.csv("E:/GEB data/American_Drought.tolerance.FDis_620_Age5_NaturalForests.csv"  )

prop_620_LL1=read.csv("E:/GEB data/American_Leaf.longevity.FDis_620_Age1_NaturalForests.csv"  )
prop_620_LL2=read.csv("E:/GEB data/American_Leaf.longevity.FDis_620_Age2_NaturalForests.csv"  )
prop_620_LL3=read.csv("E:/GEB data/American_Leaf.longevity.FDis_620_Age3_NaturalForests.csv"  )
prop_620_LL4=read.csv("E:/GEB data/American_Leaf.longevity.FDis_620_Age4_NaturalForests.csv"  )
prop_620_LL5=read.csv("E:/GEB data/American_Leaf.longevity.FDis_620_Age5_NaturalForests.csv"  )

prop_620_height1=read.csv("E:/GEB data/American_Max.height.FDis_620_Age1_NaturalForests.csv"  )
prop_620_height2=read.csv("E:/GEB data/American_Max.height.FDis_620_Age2_NaturalForests.csv"  )
prop_620_height3=read.csv("E:/GEB data/American_Max.height.FDis_620_Age3_NaturalForests.csv"  )
prop_620_height4=read.csv("E:/GEB data/American_Max.height.FDis_620_Age4_NaturalForests.csv"  )
prop_620_height5=read.csv("E:/GEB data/American_Max.height.FDis_620_Age5_NaturalForests.csv"  )
...
prop_620_all <- rbind(
  add_age_trait(prop_620_FD1, "Age1", "FD"),
  add_age_trait(prop_620_FD2, "Age2", "FD"),
  add_age_trait(prop_620_FD3, "Age3", "FD"),
  add_age_trait(prop_620_FD4, "Age4", "FD"),add_age_trait(prop_620_FD5, "Age5", "FD"),
  ## LMA
  add_age_trait(prop_620_LMA1, "Age1", "LMA"),
  add_age_trait(prop_620_LMA2, "Age2", "LMA"),
  add_age_trait(prop_620_LMA3, "Age3", "LMA"),
  add_age_trait(prop_620_LMA4, "Age4", "LMA"),
  add_age_trait(prop_620_LMA5, "Age5", "LMA"),
  ## WD
  add_age_trait(prop_620_WD1, "Age1", "WD"),
  add_age_trait(prop_620_WD2, "Age2", "WD"),
  add_age_trait(prop_620_WD3, "Age3", "WD"),
  add_age_trait(prop_620_WD4, "Age4", "WD"),
  add_age_trait(prop_620_WD5, "Age5", "WD"),
  ## Nmass
  add_age_trait(prop_620_Nmass1, "Age1", "Nmass"),
  add_age_trait(prop_620_Nmass2, "Age2", "Nmass"),
  add_age_trait(prop_620_Nmass3, "Age3", "Nmass"),
  add_age_trait(prop_620_Nmass4, "Age4", "Nmass"),
  add_age_trait(prop_620_Nmass5, "Age5", "Nmass"),
  ## Pmass
  add_age_trait(prop_620_Pmass1, "Age1", "Pmass"),
  add_age_trait(prop_620_Pmass2, "Age2", "Pmass"),
  add_age_trait(prop_620_Pmass3, "Age3", "Pmass"),
  add_age_trait(prop_620_Pmass4, "Age4", "Pmass"),
  add_age_trait(prop_620_Pmass5, "Age5", "Pmass"),
  ## ST
  add_age_trait(prop_620_ST1, "Age1", "ST"),
  add_age_trait(prop_620_ST2, "Age2", "ST"),
  add_age_trait(prop_620_ST3, "Age3", "ST"),
  add_age_trait(prop_620_ST4, "Age4", "ST"),
  add_age_trait(prop_620_ST5, "Age5", "ST"),
  ## DT
  add_age_trait(prop_620_DT1, "Age1", "DT"),
  add_age_trait(prop_620_DT2, "Age2", "DT"),
  add_age_trait(prop_620_DT3, "Age3", "DT"),
  add_age_trait(prop_620_DT4, "Age4", "DT"),
  add_age_trait(prop_620_DT5, "Age5", "DT"),
  ## LL
  add_age_trait(prop_620_LL1, "Age1", "LL"),
  add_age_trait(prop_620_LL2, "Age2", "LL"),
  add_age_trait(prop_620_LL3, "Age3", "LL"),
  add_age_trait(prop_620_LL4, "Age4", "LL"),
  add_age_trait(prop_620_LL5, "Age5", "LL"),
  ## Height
  add_age_trait(prop_620_height1, "Age1", "Height"),
  add_age_trait(prop_620_height2, "Age2", "Height"),
  add_age_trait(prop_620_height3, "Age3", "Height"),
  add_age_trait(prop_620_height4, "Age4", "Height"),
  add_age_trait(prop_620_height5, "Age5", "Height"),
  add_age_trait(prop_620_Leaf1, "Age1", "Leaf"),
  add_age_trait(prop_620_Leaf2, "Age2", "Leaf"),
  add_age_trait(prop_620_Leaf3, "Age3", "Leaf"),
  add_age_trait(prop_620_Leaf4, "Age4", "Leaf"),add_age_trait(prop_620_Leaf5, "Age5", "Leaf")
)
...
A %>%
  filter(path %in% c("FD → DBHCV → AGB")) %>%
  group_by(effect_type,path#,# combo_effect,
           # Age  
  ) %>%
...
fig_620 <- ggplot(
  ...
  #        colour = guide_legend(label.position = "left", label.hjust = 1))+
  ...
  guides(color = guide_legend(
    nrow = 2,
    direction = "horizontal"  # 在guides中指定方向
  ))
